...
const fixed = (hours) => Object.freeze({ low: hours, mid: hours, high: hours });
const ranged = (low, mid, high) => Object.freeze({ low, mid, high });
...
export const DIRECT_COST_AED = Object.freeze({});
